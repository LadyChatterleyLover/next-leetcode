    ...
    <div className='flex flex-wrap'>
      {state.companyCardList.map(item => {
        return (
          <div
            key={item.id}
            className='m-2 w-[236px] h-[250px] rounded-xl overflow-hidden flex flex-col cursor-pointer'
            style={{
          ...
          >
            ...
            <div className='h-12 bg-[#f7f7f7] flex items-center text-sm'>
              ...
              <div className='flex-1 flex items-center justify-center text-[#ffa116] cursor-pointer'>开始模拟面试</div>
            </div>
          </div>
        )
      })}
