...
import { Author1, LeetBook, SubCategory } from '@/app/types'
import { Avatar, Card, Col, Divider, Popover, Row, Spin } from 'antd'
    ...
    return (
      <div className='w-[320px] text-white bg-gradient-to-b p-4 rounded-md from-[rgba(0,0,0,.7)] to-[rgba(0,0,0,.3)]'>
        ...
        <div className='mt-2 flex items-center text-xs text-white'>
          <Avatar src={(book.author as Author1).user.userAvatar} size={22}></Avatar>
          <div className='ml-1'>{(book.author as Author1).user.realName}</div>
          <Divider type='vertical' style={{ background: 'white' }}></Divider>
